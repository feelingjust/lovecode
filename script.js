...
const animate = () => {
    ...
    if(stat){
    u.writeT("press anywhere to change",0.5*W,0.85*H);
u.writeT("Can Move Red And Blue",0.5*W,0.9*H);
    u.writeT("This Is Love Coding",0.5*W,0.95*H);}
...
const init = () => {
    ...
    turn=0;
    stat=(window.confirm("Want Open Love Coding?"));
    ropes=[];
